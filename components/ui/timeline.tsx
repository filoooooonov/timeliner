    ...
    >
      ...
      <div className="flex justify-start pt-10 md:pt-32 md:gap-10">
        <div className="flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
          {/* Circles on timeline */}
          <div className="h-6 absolute left-4 md:left-[21px] w-6 rounded-full bg-white dark:bg-black flex items-center justify-center">
          ...
          {/* Date */}
          <h3 className="hidden md:block text-lg md:pl-20 md:text-3xl font-semibold text-neutral-500 dark:text-neutral-500 ">
            Upcoming...
          </h3>
        </div>
