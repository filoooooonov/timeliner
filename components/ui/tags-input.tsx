    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-1 p-1 rounded-lg bg-background overflow-hidden  ring-muted  ",
            {
              "focus-within:ring-none ": activeIndex === -1,
            },
            className
          )}
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative px-2 mb-2 py-2 bg-neutral-900 rounded-md flex items-center gap-2 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground truncate aria-disabled:opacity-50 aria-disabled:cursor-not-allowed"
              )}
              variant={"secondary"}
            >
          ...
          <Input
            ...
            className={cn(activeIndex !== -1 && "caret-transparent")}
          />
        </div>
      </TagInputContext.Provider>
    );
